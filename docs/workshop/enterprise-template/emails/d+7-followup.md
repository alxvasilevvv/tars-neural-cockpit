# D+7 — one-week follow-up

**Subject:** 1 week later — how's your strategy doing?

---

Hi {FIRST_NAME},

It's been a week since you closed your laptop on Day 2. Quick
check-in.

## How's the paper session running?

If you've kept the paper trade live, you should have around
seven days of receipts in your ledger by now. Open
`http://localhost:{TARS_PORT}/compliance` to see them — that
view is what most attendees show their risk committee for the
first conversation about promoting a strategy to live capital.

If the paper session stopped at some point during the week, the
ledger will tell you when and why. The two most common causes
are sidecar restarts (the ledger picks up automatically on
relaunch, no data loss) and risk policy hits (the strategy
parked itself, exactly as designed).
...
Either way, thanks for showing up and doing the work.
