...
| `tars-doctor` — single-command health check across MCP / Clone sync / daemon / scheduler / webhooks / cowork / receipts / vault *(Wave 154)* | `backend/core/doctor/`, `scripts/tars-doctor`, `tests/test_doctor.py`, `docs/contracts/DOCTOR.md` |
